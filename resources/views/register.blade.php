  ...
  <form method="POST">
    <div class="form-grid">
      ...
      <div class="form-column">
        ...
        <div class="field"><i class="fas fa-phone"></i><input type="tel" name="phone" placeholder="Phone Number" required></div>
        <div class="field"><i class="fas fa-calendar"></i><input type="date" name="birthdate" id="birthdate" required></div>
        <div class="field"><i class="fas fa-hourglass-half"></i><input type="number" id="age" name="age" placeholder="Age" readonly></div>
        <div class="field">
        ...
        <div class="field"><i class="fas fa-map-marker-alt"></i><input type="text" name="street" placeholder="Street" required></div>
        <div class="field"><i class="fas fa-map"></i><input type="text" name="region" placeholder="Region" required></div>
      </div>

      <!-- Column 2 -->
      <div class="form-column">
        <div class="field"><i class="fas fa-envelope"></i><input type="email" name="email" placeholder="Email" required></div>
        <div class="field"><i class="fas fa-city"></i><input type="text" name="city" placeholder="City" required></div>
        <div class="field"><i class="fas fa-mail-bulk"></i><input type="text" name="zip_code" placeholder="Postal Code" required></div>
