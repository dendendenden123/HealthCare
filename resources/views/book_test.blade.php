        ...
        <form method="POST">
          <div class="row g-4">
            ...
            <div class="col-md-6">
              ...
              <?php
              $hematology = [
                1 => ["CBC", 180], 2 => ["BLEEDING TIME", 80], 3 => ["CLOTTING TIME", 80],
                4 => ["PLATELET COUNT", 75], 5 => ["HEMATOCRIT / HEMAGLOBIN", 75]
              ];
              ...
              <?php
              $immuno = [
                6 => ["TSH", 600], 7 => ["T3", 545], 8 => ["T4", 545], 9 => ["FT3", 545], 10 => ["FT4", 545]
              ];
              ...
              <?php
              $serology = [
                11 => ["BLOOD TYPING",130], 12 => ["HAV",470], 13 => ["HBs Ag",160], 14 => ["SYPHILIS",120],
                15 => ["TYPHIDOT",620], 16 => ["HIV",400], 17 => ["DENGUE TEST",1200], 18 => ["PREGNANCY TEST (SERUM)",170]
              ];
            ...
            <div class="col-md-6">
              ...
              <?php
              $micro = [
                19 => ["URINALYSIS", 100], 20 => ["STOOL EXAM", 70], 21 => ["PREGNANCY TEST (URINE)", 150]
              ];
              ...
              <?php
              $chemistry = [
                22 => ["LIPID PANEL",400], 23 => ["CHOLESTEROL",110], 24 => ["TRIGLYCERIDES",140], 25 => ["HDL/LDL",200],
                26 => ["FBS/RBS",100], 27 => ["OGTT",450], 28 => ["HBA1C",670], 29 => ["SGOT/AST",170], 30 => ["SGP/ALT",170],
                31 => ["URIC ACID",110], 32 => ["CREATININE",110], 33 => ["BUN",120], 34 => ["SODIUM",280],
                35 => ["POTASSIUM",280], 36 => ["CHLORIDE",280]
              ];
